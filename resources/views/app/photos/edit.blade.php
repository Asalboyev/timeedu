                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <div class="my-4">
                                                ...
                                                <textarea class="form-control" placeholder="Enter your description..." id="textarea" rows="4" name="desc[{{ $language->small }}]">{{ old('desc.'.$language->small) ?? $photo->desc[$language->small] ?? null }}</textarea>
                                            </div>
                                            <!-- End of Form -->
                                        </div>
                                    </div>
