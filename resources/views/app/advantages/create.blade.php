                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) }}" id="title" placeholder="Заголовок...">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('advantage_category_id') is-invalid @enderror" id="advantage_category_id" name="advantage_category_id">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('advantage_category_id') == $item->id ? 'selected' : '' }}>{{ $item->title[$main_lang->code] }}</option>
                                        @endforeach
                                    </select>
