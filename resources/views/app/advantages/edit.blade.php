                    ...
                    <form method="post" action="{{ route($route_name . '.update', [$route_parameter => $advantage]) }}" enctype="multipart/form-data" id="add">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('title.'.$lang->code) is-invalid @enderror" name="title[{{ $lang->code }}]" value="{{ old('title.'.$lang->code) ?? $advantage->title[$lang->code] ?? null }}" id="title" placeholder="Заголовок...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('desc.'.$lang->code) is-invalid @enderror ckeditor" name="desc[{{ $lang->code }}]" placeholder="Описание...">{{ old('desc.'.$lang->code) ?? $advantage->desc[$lang->code] ?? null }}</textarea>
                                ...
                                <div class="form-group">
                                    <label for="advantage_category_id" class="form-label">Категория</label>
                                ...
                                <div class="form-group">
                                    <!-- Dropzone -->
                                    <label for="dropzone" class="form-label">Картинка для фона</label>
