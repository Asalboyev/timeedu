            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" style="width: 100px">{{ $works->firstItem() + $key }}</th>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="imb-block me-2 overflow-hidden">
                                        <img src="{{ isset($item->main_img) ? $item->sm_main_img : asset('assets/img/default.png') }}" alt="">
                                    </div>
                            ...
                            <td>
                                ...
                                <span>{{ $loop->iteration }}. {{ $service->title[$main_lang->code] }}</span>
                                @if(!$loop->last)
                                <br>
                                @endif
                                @endforeach
