...
@endforeach
                  ...
                  <div class="form-group">
                                        ...
                                        <input type="number"  class="form-control @error('path') is-invalid @enderror" name="formmenu[${form1Count}][order]" value="{{ old('path') }}" id="order" placeholder="Order...">
...
@endforeach
                ...
                <div class="form-group">
                    ...
                    <select id="categories" class="form-control mb-4 @error('categories') is-invalid @enderror"
...
@error('categories')
                <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group">
                                        <label for="in_main" class="form-label">Order</label>
                                        <input type="number"  class="form-control @error('path') is-invalid @enderror" name="formmenu2[${form1Count}][order]" value="{{ old('path') }}" id="order" placeholder="Order...">
...
@endforeach
                  ...
                  <div class="form-group">
                        ...
                        <select name="formmenu[${form1Count}][position]" class="form-select">
  ...
  <div class="form-group">
                                        <label for="in_main" class="form-label">Order</label>
                                        <input type="number"  class="form-control @error('path') is-invalid @enderror" name="formmenu3[${form1Count}][order]" value="{{ old('path') }}" id="order" placeholder="Order...">
                                        @error('in_main')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
                                    </span>
            ...
            setTimeout(function () {
                ...
                new Dropzone(`div#${uniqueDropzoneId}`, {
                    ...
                    success: (file, response) => {
                        ...
                        // If it's the first image, add it to the input, otherwise append
                        if (hiddenInput.value) {
                            hiddenInput.value += `,${response.file_name}`; // Add the new file name to the existing one
                        } else {
                            hiddenInput.value = response.file_name; // Set the value for the first image
                        }
                    },
                    removedfile: function (file) {
                        ...
                        if (index !== -1) {
                            ...
                            hiddenInput.value = fileNames.join(','); // Update the input value
                        }
                    },
                    error: function (file, message) {
                        alert(message);
