                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('parent_id') is-invalid @enderror" id="parent_id" data-choices='{"": true}' name="parent_id">
                                                ...
                                                @foreach ($departaments as $key => $item)
                                                    <option value="{{ $item->id }}" {{ old('parent_id') == $item->id ? 'selected' : '' }}>{{ $item->name[$main_lang->code] }}</option>
                                                @endforeach
                                            </select>
                                            @error('parent_id')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('structure_type_id') is-invalid @enderror" id="structure_type_id" data-choices='{"": true}' name="structure_type_id">
                                                ...
                                                @foreach ($StructureTypes as $key => $item)
                                                    <option value="{{ $item->id }}" {{ old('structure_type_id') == $item->id ? 'selected' : '' }}>{{ $item->name[$main_lang->code] }}</option>
                                                @endforeach
                                            </select>
                                            @error('parent_id')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " name="code" value="{{ old('code') }}" id="subtitle" placeholder="Code...">
                                            @error('code')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
