                                    ...
                                    @foreach($langs as $lang)
                                        ...
                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="dec[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('dec.'.$lang->code) is-invalid @enderror ckeditor" name="desc[{{ $lang->code }}]" placeholder="Description...">{{ old('desc.'.$lang->code) ??  $activitie->title[$lang->code] ?? '' }}</textarea>
