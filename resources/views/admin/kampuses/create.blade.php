...
~
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea  id="desc" cols="30" rows="10" class="form-control @error('third_description.'.$lang->code) is-invalid @enderror ckeditor" name="third_description[{{ $lang->code }}]" placeholder="Third description...">{{ old('third_description.'.$lang->code) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date" name="educational_programs" class="form-control" value="{{ old('educational_programs') }}" placeholder="educational_programs"  />
                                </div>
                                <div class="form-group">
                                    <label for="date" class="form-label">Audience size</label>
                                    <input type="text" id="date" name="audience_size" class="form-control" value="{{ old('audience_size') }}" placeholder="audience_size"  />
                                </div>
                                <div class="form-group">
                                    <label for="date" class="form-label">Green zone</label>
                                    <input type="text" id="date" name="green_zone" class="form-control" value="{{ old('green_zone') }}" placeholder="green_zone"  />
                                </div>
