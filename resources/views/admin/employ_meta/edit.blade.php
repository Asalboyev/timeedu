        ...
        <div class="row">
            <div class="col-8">
                <div class="card mw-50">
                    <div class="card-body">
                        <form method="post" action="{{ route('employ_meta.update', $employMeta->id) }}" enctype="multipart/form-data" id="add">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="date" name="contrakt_date" class="form-control" value="{{ old('date') ?? $employMeta->contrakt_date }}" placeholder="{{ date('d-m-Y') }}" data-flatpickr='{"dateFormat": "d-m-Y"}' />
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle" class="form-label">Contrakat Number</label>
                                        <input type="text" class="form-control " name="contrakt_number" value="{{ old('contrakt_number') ?? $employMeta->contrakt_number}}" id="subtitle" placeholder="contrakt_number...">
