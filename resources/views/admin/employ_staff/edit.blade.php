        ...
        <div class="row">
            <div class="col-8">
                <div class="card mw-50">
                    <div class="card-body">
                        <form method="post" action="{{ route($route_name . '.update', $employStaff->id) }}" enctype="multipart/form-data" id="add">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="active" class="form-select">
                                            <option value="1" {{ $employStaff->active == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $employStaff->active == 0 ? 'selected' : '' }}>NeActive</option>
                                        </select>
